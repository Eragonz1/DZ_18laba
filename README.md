...
Создать структуру для хранения записи, организовать в программе ввод 5-10 различных
записей, из полученного массива структур найти и напечатать информацию согласно варианту:
...
Определить средний стаж работы и вывести все сведения о
сотрудниках, стаж которых выше среднего.
...
<img width="905" height="964" alt="image" src="https://github.com/user-attachments/assets/1c2d9560-4f12-4d40-a02c-4664f44b7d56" />
